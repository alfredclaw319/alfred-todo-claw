defmodule TodoAppWeb.TodoLiveTest do
  ...
  @create_attrs %{completed: true, notes: "some notes", title: "some title"}
  @update_attrs %{completed: false, notes: "some updated notes", title: "some updated title"}
  @invalid_attrs %{completed: false, notes: nil, title: nil}
