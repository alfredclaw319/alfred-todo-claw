defmodule TodoAppWeb.TodoLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      <.header>
        {@title}
        <:subtitle>Capture the thing. Spare your future self the treasure hunt.</:subtitle>
      </.header>
      ...
      >
        <.input
          ...
          type="text"
          label="Task"
          placeholder="Buy coffee, conquer inbox..."
        />
        <.input field={@form[:notes]} type="textarea" label="Notes" placeholder="Optional details" />
